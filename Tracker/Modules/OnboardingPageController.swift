...
//  Tracker
//
//  Created by Александр Гегешидзе on 11.04.2024.
//
...
final class OnboardingPageViewController: UIPageViewController {
    ...
    private var pages: [OnboardingModel] = [
        OnboardingModel(text: "Отслеживайте только\nто, что хотите", image: Resources.Images.onboardingPage1),
        OnboardingModel(text: "Даже если это\nне литры воды и йога", image: Resources.Images.onboardingPage2)
    ]
